...
# Generated by qmake (2.01a) (Qt 4.8.5) on: Fri Oct 10 14:48:23 2014
...
CXXFLAGS      = -std=c++11 -pipe -O2 -g -pipe -Wall -Wp,-D_FORTIFY_SOURCE=2 -fstack-protector-strong --param=ssp-buffer-size=4 -grecord-gcc-switches -m64 -mtune=generic -O2 -Wall -W -D_REENTRANT $(DEFINES)
